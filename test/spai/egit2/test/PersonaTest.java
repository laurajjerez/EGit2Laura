...
public class PersonaTest {
    ...
    public void initObjects() {
        this.persona = new Persona("Ana ", "Vega","Pe�a");
    }
    ...
    public void testsetSegundoApellido(){
    	this.persona.setSegundoApellido(" Pe�a ");
    	assertEquals("Pe�a", this.persona.getSegundoApellido());
    }
    @Test
    ...
    public void testNombreCompleto() {
        assertEquals("Ana Vega Pe�a", this.persona.nombreCompleto());
    }
